  ...
  return (
    <>
      <input
        ...
        name={name}
        id={name}
        className="mt-0.5 h-4 w-4 flex-none appearance-none rounded-[.1875rem] border-[1px] border-solid border-black/10 bg-white bg-center shadow-[0_0.0625rem_0.125rem_0_rgba(0,0,0,.1)] outline-none checked:bg-[#ff7843] focus:ring-2 ring-[#ff7843]"
        style={{
